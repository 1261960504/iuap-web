...
import userLog from "static/images/icon-user.png";
import passwordLog from "static/images/icon-password.png";
                    ...
                    <div className="content-right">
                        <div className="login-panel-out">
                            <div className="login-panel" style={{ paddingTop: m_top, paddingBottom: m_bottom }}>
                                ...
                                <div>
                                    <img className="userNAme" src={userLog} />
                                ...
                                <div>
                                    <img className="userNAme" src={passwordLog} />
